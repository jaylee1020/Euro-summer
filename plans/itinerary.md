...
- **확정 도시**: 런던, 파리, 니스, 베네치아, 돌로미테(도비아코), 뮌헨
- **동행**: 엄마 (7/3~7/7 런던) / 오서경 (7/7~7/19)
...
| 파리 | 7/8 ~ 7/9 | 파리 (서경 동행) | 2박, 서경 7/9 아침까지 파리 |
| 이동 | 7/10 오전 | TGV 파리 → 니스 | 미예약 |
| 니스 | 7/10 ~ 7/11 | 니스/모나코/Èze (서경 동행) | 2박, 칸 스킵 |
| 이동 | 7/12 | 니스 → 베네치아 (항공) | ~₩12만, 미예약 |
| 베네치아 | 7/13 오전 | 베네치아 반나절 (서경 동행) | |
| 이동 | 7/13 오후 | 베네치아 → 도비아코 (버스) | ~3시간, 미예약 |
| 돌로미테 | 7/14 ~ 7/17 | Alta Via 1 트레킹 (서경 동행) | 4일 |
| 미정 | 7/18 ~ 7/19 | ? (서경 동행 마지막) | 미정 |
| 솔로 | 7/19 ~ 7/27 | 스위스 → 오스트리아 → 독일(뮌헨) | 미정 |
...
## Phase 3-A: 파리 + 남프랑스 + 이탈리아 (서경 동행)
> 동행: 오서경 (7/7~7/19 or 7/20) | ⚠️ 합의안 있으나 전 구간 미예약
...
### Day 18 - 2026-07-13 (월) | 베네치아 → 도비아코
- [ ] 오전: 베네치아 반나절 관광
- [ ] 오후: 베네치아 → 도비아코 버스 (~3시간, 미예약)
- [ ] 도비아코 도착, 트레킹 준비
- **숙소**: 도비아코 (미정)

### Day 19~22 - 2026-07-14 ~ 2026-07-17 | Dolomites Alta Via 1
- [ ] 7/14: Alta Via 1 Day 1
- [ ] 7/15: Alta Via 1 Day 2
- [ ] 7/16: Alta Via 1 Day 3
- [ ] 7/17: Alta Via 1 Day 4
- **숙소**: 산장 (Rifugio) - 패키지 예약 검토 중
- **메모**: 트레킹 장비 준비 필요 (→ packing.md 참조)
- **패키지 검토 중**:
  - [AV1-4C](https://www.alpenventuresunguided.com/av1-4c/) - 중부 구간
  - [AV1-4N](https://www.alpenventuresunguided.com/av1-4n/) - 북부 구간
  - (!) 7월 성수기 대부분 마감 상태, 빠른 결정 필요

### Day 23 - 2026-07-18 (토) | 트레킹 종료, 서경은 뮌헨으로
- [ ] 서경: 트레킹 종료 지점 → 뮌헨 이동 (기차 ~6시간)
- [ ] 본인: 돌로미테/이탈리아 쪽에서 천천히 이동 시작
- **메모**: 서경만 뮌헨으로 이동, 본인은 스위스/오스트리아 방면으로 느긋하게

### Day 24 - 2026-07-19 (일) | 서경 귀국 (뮌헨)
- [ ] 서경 MUC 출발 19:45 (PEK 경유 → ICN 7/20 18:30 도착)
- **예약번호**: FKKTKM
- **본인**: 돌로미테 근처 또는 인스브루크 방면 이동 중

---

## Phase 3-B: 솔로 구간 (7/18 ~ 7/27)
> 트레킹 종료 후 돌로미테에서 천천히 뮌헨까지, 약 10일
> 방향: **돌로미테 → 오스트리아/스위스 → 독일(뮌헨)**
> (!) 7/27까지 뮌헨 도착 필수 (7/28 아침 MUC 출발)
...
**루트 B (디자인 집중, 추천):**
- 돌로미테 → 인스브루크 (하디드 건축) → 취리히 2박 (Chipperfield, Le Corbusier)
- → 바젤 (Vitra Campus) → 슈투트가르트 (바이센호프, 이은영 시립도서관) → 뮌헨

**루트 A (클래식 알프스):**
- 돌로미테 → 인스브루크 → 취리히 → 베른 → 루체른 → 잘츠부르크 → 뮌헨

**루트 C (힐링, 체력 회복 우선):**
- 돌로미테 → 인스브루크 → 루체른 2박 → 베른 → 잘츠부르크 → 뮌헨
